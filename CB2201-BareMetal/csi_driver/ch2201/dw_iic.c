...
#if defined CONFIG_DW_DMAC
void dw_iic_dma_event_cb(int32_t ch, dma_event_e event)
{
...
static int32_t dw_iic_send_dma(dw_iic_priv_t *iic_priv, const void *data, uint32_t num)
{
    ...
    ret = csi_dma_config_channel(iic_priv->dma_tx_ch, &config, dw_iic_dma_event_cb);
...
static int32_t dw_iic_receive_dma(dw_iic_priv_t *iic_priv, void *data, uint32_t num)
{
    ...
    ret = csi_dma_config_channel(iic_priv->dma_rx_ch, &config, dw_iic_dma_event_cb);
