...
#define COMM_IDX        1
#define COMM_TXD        PA17
#define COMM_RXD        PA16
#define COMM_TXD_FUNC   PA17_UART1_TX
#define COMM_RXD_FUNC   PA16_UART1_RX
...
#define EXAMPLE_ADC_CHANNEL     EXAMPLE_ADC_CH0
